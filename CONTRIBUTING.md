# Contributing to DbConfig

Thank you for your interest in contributing to DbConfig!
...
1. Clone the repository into your CakePHP application's `plugins` directory:
   ...
   git clone https://github.com/CakePHPMitra/dbconfig.git
   ```
...
- Use the [Issue Tracker](https://github.com/CakePHPMitra/dbconfig/issues)
